...
// SmoothNoise.cpp
//
#include "ThirdParty/Squirrel/Noise/RawNoise.hpp"			// for raw bit-noise base functions (SquirrelNoise4)
...
{
	const float OCTAVE_OFFSET = 0.f;// 0.636764989593174f; // Translation/bias to add to each octave
