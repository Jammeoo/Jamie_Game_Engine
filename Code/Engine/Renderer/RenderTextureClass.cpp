...
void RenderTextureClass::ClearRenderTarget(ID3D11DeviceContext* deviceContext, ID3D11DepthStencilView* depthStencilView, Rgba8 const& color)
{
	float colorPtr[4];
	color.GetAsFloats(colorPtr);
	// Clear the back buffer.
	deviceContext->ClearRenderTargetView(m_renderTargetView, colorPtr);
